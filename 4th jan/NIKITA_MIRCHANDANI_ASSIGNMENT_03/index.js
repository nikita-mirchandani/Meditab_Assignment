...
const addphoneheader=`<div class="phone-header-content">                         
<div class="phone-header">
    <p class="type">Type</p>
    <p class="code">Code</p>
    <p class="number">Number</p>
...
const addphoneinputs = `<div class="phone-inputs-container">
<div class="phone-inputs">
    <select name="type1" id="type1" class="type-input">
        <option value="Cell">Cell</option>
        <option value="Landline">Landline</option>
...
function add_phone_icon(btn){
  if(btn.closest('.phone').querySelector('.phone-content').childElementCount == 0)
  {
      btn.closest('.phone').querySelector('.phone-content').innerHTML += addphoneheader;
  }
            
  btn.closest('.phone').querySelector('.phone-content').innerHTML += addphoneinputs;
 }
function delete_phone_details(deletebtn){
  if(deletebtn.closest('.phone-content').childElementCount == 2)
  {
    deletebtn.closest('.phone').querySelector('.phone-header-content').remove();
  }
  deletebtn.closest('.phone-inputs-container').remove();
...
const addfaxinputs=`  <div class="fax-inputs-container">
...
const addfaxheader=` <div class="fax-header-content">
...
function add_fax_icon(btn){
  if(btn.closest('.fax').querySelector('.fax-content').childElementCount == 0)
  {
      btn.closest('.fax').querySelector('.fax-content').innerHTML += addfaxheader;
  }
            
  btn.closest('.fax').querySelector('.fax-content').innerHTML += addfaxinputs;
}
function delete_fax_details(deletebtn){
  if(deletebtn.closest('.fax-content').childElementCount == 2)
  {
    deletebtn.closest('.fax').querySelector('.fax-header-content').remove();
  }
  deletebtn.closest('.fax-inputs-container').remove();
}
