...
INSERT INTO RACE(RACE_TYPE,PATIENT_ID) VALUES(1,'0013');
SELECT * FROM RACE;
...
INSERT INTO ADDRESS(ADDRESS_TYPE,STREET,CITY,ZIP,PATIENT_ID) VALUES(1,'STREET','rajkot',387630,'0013');
SELECT * FROM ADDRESS;
...
INSERT into PHONE(PHONE_NUMBER,PHONE_TYPE,PRIMARY_PHONE,ADDRESS_ID) VALUES (8849126581,1,false,4);
SELECT * from PHONE;
...
INSERT into FAX(ADDRESS_ID,FAX_NUMBER,PRIMARY_FAX) VALUES (4,5313,false);
SELECT * from FAX;
