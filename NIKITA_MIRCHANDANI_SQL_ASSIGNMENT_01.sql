...
-- SELECT Patient.*,PHONE.* FROM ((Patient INNER JOIN ADDRESS) INNER JOIN PHONE) ON PHONE.ADDRESS_ID = ADDRESS.ADDRESS_ID AND Patient.patient_id = ADDRESS.patient_id;
